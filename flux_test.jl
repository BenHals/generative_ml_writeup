...
# ╔═╡ 96e474ba-cc66-11ee-012b-ddfb0c2a6cee
using Random, Plots, StatsBase, Flux

# ╔═╡ f8df35cb-995a-486f-80ab-651e13c7ea19
begin
...
# ╔═╡ ef54ee59-7bdc-48bc-a345-05a58f1f99d2
begin
	n_samples = 1000
...
# ╔═╡ 88563700-9fcf-4695-88c2-1ea92d655831
...
# ╔═╡ aefb7571-fc73-44d7-b0c7-60b4214348d7
struct DiffusionSteps{V::AbstractVector}
	# Container for timesteps across the diffusion process
	num_timesteps::Int
	data_shape::NTuple
	...
	alphas::V
	alpha_products::V
	alpha_products_prev::V

	sqrt_alpha_products::V
	sqrt_inverse_alpha_produces::V
end
...
manifest_format = "2.0"
project_hash = "fcae16c55e4236fa2678e3cc86d0e4db009eb919"
